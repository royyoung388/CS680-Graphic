...
class SceneTwo(Component, SceneBase):
    shaderProg = None
    glutility = None
    ...
    def __init__(self, shaderProg):
        ...
        l0 = Light(Point([0.0, 1.5, 0.0]), np.array((*ColorType.WHITE, 1.0)))
        ...
        l1 = Light(Point([0.0, -1.5, 0.0]), np.array((*ColorType.WHITE, 1.0)), spotDirection=Point((0, 1, 0)),
                   spotRadialFactor=np.array((0.5, 1, 1)), spotAngleFactor=5, spotAngleLimit=30)
        lightCube1 = Component(Point((0.0, -1.5, 0.0)), DisplayableCube(shaderProg, 0.1, 0.1, 0.1, ColorType.WHITE))
