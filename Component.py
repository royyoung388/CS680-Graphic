...
class Component:
    ...
    def update(self, parentTransformationMat=None):
        ...
        # Change this line
        self.transformationMat = parentTransformationMat @ translationMat @ scalingMat @ self.postRotationMat @ rotationMatW @ rotationMatV @ rotationMatU @ self.preRotationMat
