...
class Light:
    ...
    spotAngleFactor = None
    spotAngleLimit = None

    def __init__(self, position=None, color=None, infiniteDirection=None, spotDirection=None, spotRadialFactor=None,
                 spotAngleFactor=2, spotAngleLimit=0):
        # set basic light
        self.lightOn = True
        ...
        self.setSpotAngleFactor(spotAngleFactor)
        self.setSpotAngleLimit(spotAngleLimit)

    def __repr__(self):
        return f"on: {self.lightOn}, pos: {self.position}, color:{self.color},\
        {self.infiniteOn},{self.infiniteDirection},\
        {self.spotOn},{self.spotDirection}, {self.spotRadialFactor}, {self.spotAngleFactor}, {self.spotAngleLimit}"
    ...
    def setSpotAngleFactor(self, spotAngleFactor):
        if type(spotAngleFactor) != (int or float):
            raise TypeError("spotAngleFactor must be a int/float")
        self.spotAngleFactor = spotAngleFactor
